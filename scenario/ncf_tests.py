...
if not cfengine_version:
  ...
  shell_on("agent", export_prefix + ";sh /tmp/ncf-setup test-local https://github.com/Normation/ncf.git#branches/rudder/" + tag + " " + cfengine_version + " --testinfra", live_output=True)
