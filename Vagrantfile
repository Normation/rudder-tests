...
configure(config, centos6, 'centos', 3, 0, '3.0-nightly')
configure(config, centos6, 'centos', 3, 1, '3.0-nightly')
### END OF AUTOGENERATION FOR centos

### AUTOGENERATED FOR PLATFORM debian (4)
configure(config, debian7, 'debian', 4, 0, '3.0-nightly')
configure(config, debian7, 'debian', 4, 1, '3.0-nightly')
