...
configure(config, sles11, 'sles', 2, 0, '2.10-nightly')
configure(config, sles11, 'sles', 2, 1, '2.10-nightly')
### END OF AUTOGENERATION FOR sles

### AUTOGENERATED FOR PLATFORM centos (3)
configure(config, centos6, 'centos', 3, 0, 'ci/2.10.9-2')
configure(config, centos6, 'centos', 3, 1, 'ci/2.10.9-2')
